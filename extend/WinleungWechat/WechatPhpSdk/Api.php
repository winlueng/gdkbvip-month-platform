<?php
namespace WinleungWechat\WechatPhpSdk;

use WinleungWechat\WechatPhpSdk\Utils\HttpCurl;
use WinleungWechat\WechatPhpSdk\Utils\Error;
use WinleungWechat\WechatPhpSdk\Utils\SHA1;
use WinleungWechat\WechatPhpSdk\Utils\Xml;
 ...
 * - 卡券接口 (卡券列表, 卡券添加, 卡券查询)
 * Class Api
 * @package WinleungWechat\WechatPhpSdk
 */
